...
const LoginForm = ({ isModalOpen, onClose, switchToSignup, redirectUrl, switchToForgotPassword }) => {
      ...
      <form className='m-auto max-w-[500px] bg-white dark:bg-ui-dark-primary p-8'>
        {loading ? (
          ...
          <>
            ...
            <div className='pt-4'>
              <span onClick={switchToSignup} className='block text-blue-400 cursor-pointer'>Don't have an account? Signup here</span>
              <span onClick={switchToForgotPassword} className='block text-blue-400 cursor-pointer'>Forgot Password?</span>
            </div>
          </>
        )}
      </form>
